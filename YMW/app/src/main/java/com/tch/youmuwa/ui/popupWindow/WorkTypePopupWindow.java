...
public class WorkTypePopupWindow extends PopupWindow {
    ...
    public WorkTypePopupWindow(Context context, WorkerTypeInterface pi) {
        this.context = context;
        this.pi = pi;
        this.view = LayoutInflater.from(context).inflate(R.layout.popup_worker_type, null);
        initView();
        successView();
        ...
        adapter = new CommonAdapter<WorkerTypeResult.DataBean>(context, R.layout.item_worker_type, types) {
            ...
            protected void convert(ViewHolder viewHolder, WorkerTypeResult.DataBean item, int cPosition) {
                ...
                if (nPosition == cPosition) {
                    ...
                    viewHolder.setBackgroundRes(R.id.tvWorkType, R.drawable.oval_worker_type_select);
                } else {
