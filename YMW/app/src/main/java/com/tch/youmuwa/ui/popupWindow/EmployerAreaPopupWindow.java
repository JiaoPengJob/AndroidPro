...
public class EmployerAreaPopupWindow extends PopupWindow {
    ...
    public EmployerAreaPopupWindow(Context context, PopupInterface pi) {
        this.context = context;
        this.pi = pi;
        this.view = LayoutInflater.from(context).inflate(R.layout.popup_employer_area, null);
        initView();
