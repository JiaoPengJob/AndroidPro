...
public class IndexBar extends View {
    ...
    public IndexBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        normalColor = a.getColor(R.styleable.IndexBar_normalColor, Color.parseColor("#666666"));
        selecColor = a.getColor(R.styleable.IndexBar_selecColor, Color.parseColor("#31D09A"));
