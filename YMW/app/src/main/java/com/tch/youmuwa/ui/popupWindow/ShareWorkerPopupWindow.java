...
public class ShareWorkerPopupWindow extends PopupWindow {

    private Context context;
    private View view;
    private ShareInterface si;

    public ShareWorkerPopupWindow(Context context, ShareInterface si) {
        this.context = context;
        this.si = si;
        this.view = LayoutInflater.from(context).inflate(R.layout.popup_share, null);
