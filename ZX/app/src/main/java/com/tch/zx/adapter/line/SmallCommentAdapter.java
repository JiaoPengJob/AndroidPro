...
public class SmallCommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context context;
    private String commentType;
    private List<SmallCommentResultBean.ResultBean.ResponseObjectBean> commentBeans;
    private GiveFabulousPresenter giveFabulousPresenter;

    public SmallCommentAdapter(Context context, List<SmallCommentResultBean.ResultBean.ResponseObjectBean> commentBeans, String commentType) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new SmallCommentAdapter.MyHolder(layout);
    }

    @Override
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof SmallCommentAdapter.MyHolder) {
            ...
            ((MyHolder) holder).ivZan.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    giveFabulous(String.valueOf(commentBeans.get(position).getSmallClassCommId()));
                }
            });
        }
    }
