...
import com.tch.zx.adapter.contacts.NeedIndustryAdapter;
import com.tch.zx.adapter.contacts.OfferIndustryAdapter;
...
public class OfferIndustryFragment extends Fragment {
     ...
     * 适配器
     */
    private OfferIndustryAdapter industryAdapter;
    ...
    private void userOfferIndustry() {
        presenter = new BasePresenter<Object>(getActivity());
        presenter.onCreate();
        presenter.attachView(userOfferIndustryView);
        ...
        presenter.userOfferIndustry(data);
    }

    private BaseView<Object> userOfferIndustryView = new BaseView<Object>() {
        @Override
        ...
        public void onError(String result) {
            ...
            Log.e("ZX", "userOfferIndustryView接口错误" + result);
        }
    };
    ...
    private void setRvData() {
        industryAdapter = new OfferIndustryAdapter(getContext(), list);
        ...
        industryAdapter.setOnItemClickListener(new OfferIndustryAdapter.OnItemClickListener() {
            @Override
