...
import com.tch.zx.adapter.purchased.OnlinePurchasedAdapter;
...
public class OnlinePurchasedFragment extends Fragment {
    ...
    public void setRvData(List<OrderListResultBean.ResultBean.ResponseObjectBean> list) {
        //已购选项卡显示适配器
        OnlinePurchasedAdapter purchasedAdapter = new OnlinePurchasedAdapter(getContext(), list);
        ...
        purchasedAdapter.setOnItemClickListener(new OnlinePurchasedAdapter.OnItemClickListener() {
            @Override
