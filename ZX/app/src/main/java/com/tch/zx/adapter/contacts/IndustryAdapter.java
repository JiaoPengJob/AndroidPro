...
public class IndustryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public IndustryAdapter(Context context, List<UserFollowIndustryResult.ResponseObjectBean> list) {
