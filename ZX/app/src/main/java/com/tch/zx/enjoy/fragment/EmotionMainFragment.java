...
import com.tch.zx.R;
import com.tch.zx.enjoy.adapter.HorizontalRecyclerviewAdapter;
import com.tch.zx.enjoy.adapter.NoHorizontalScrollerVPAdapter;
import com.tch.zx.enjoy.emotionkeyboardview.EmotionKeyboard;
import com.tch.zx.enjoy.emotionkeyboardview.NoHorizontalScrollerViewPager;
import com.tch.zx.enjoy.model.ImageModel;
import com.tch.zx.enjoy.utils.EmotionUtils;
import com.tch.zx.enjoy.utils.GlobalOnItemClickManagerUtils;
import com.tch.zx.enjoy.utils.SharedPreferencedUtils;
...
//                .bindToEditText(!isBindToBarEditText ? ((EditText) contentView) : ((EditText) rootView.findViewById(R.id.bar_edit_text)))//判断绑定那种EditView
                .bindToEditText(((EditText) contentView))
    ...
    public void bindToEmotionButton(ImageView iv) {
        this.emotion_button = iv;
    }
