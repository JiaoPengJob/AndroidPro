...
public class NeedIndustryFragment extends Fragment {
     ...
     * 适配器
     */
    private NeedIndustryAdapter industryAdapter;
    ...
    private void userNeedIndustry() {
        presenter = new BasePresenter<Object>(getActivity());
        presenter.onCreate();
        presenter.attachView(userNeedIndustryView);
        ...
        presenter.userNeedIndustry(data);
    }

    private BaseView<Object> userNeedIndustryView = new BaseView<Object>() {
        @Override
        ...
        public void onError(String result) {
            ...
            Log.e("ZX", "userNeedIndustryView接口错误" + result);
        }
    };
    ...
    private void setRvData() {
        industryAdapter = new NeedIndustryAdapter(getContext(), list);
        ...
        industryAdapter.setOnItemClickListener(new NeedIndustryAdapter.OnItemClickListener() {
            @Override
