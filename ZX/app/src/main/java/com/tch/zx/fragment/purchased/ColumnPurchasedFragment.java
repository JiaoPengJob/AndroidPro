...
import com.tch.zx.adapter.purchased.ColumnPurchasedAdapter;
...
import static com.tch.zx.application.RxRetrofitApp.init;

/**
 * 已购/专栏
 */

public class ColumnPurchasedFragment extends Fragment {
    ...
    public void setRvData(List<OrderListResultBean.ResultBean.ResponseObjectBean> list) {
        //已购选项卡显示适配器
        ColumnPurchasedAdapter purchasedAdapter = new ColumnPurchasedAdapter(getContext(), list);
        ...
        purchasedAdapter.setOnItemClickListener(new ColumnPurchasedAdapter.OnItemClickListener() {
            @Override
