...
public class OffLineCommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context context;
    private List<OfflineCommentResultBean.ResultBean.ResponseObjectBean> commentBeans;
    private GiveFabulousPresenter giveFabulousPresenter;

    public OffLineCommentAdapter(Context context, List<OfflineCommentResultBean.ResultBean.ResponseObjectBean> commentBeans) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new OffLineCommentAdapter.MyHolder(layout);
    }

    @Override
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OffLineCommentAdapter.MyHolder) {
            ...
            ((MyHolder) holder).ivZan.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    giveFabulous(String.valueOf(commentBeans.get(position).getOfflineId()));
                }
            });
        }
    }
