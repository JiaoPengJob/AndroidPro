 ...
 * 解决初始化选中指示器显示问题
 */
public class MyEasyIndicator extends LinearLayout implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    public MyEasyIndicator(Context context) {
        super(context);
    }

    public MyEasyIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init(TypedArray a) {
        ...
        LayoutParams params = new LayoutParams(1000, LayoutParams.WRAP_CONTENT);
    ...
    public void setTabTitles(String[] tabTitles, final int position, HorizontalScrollView scrollView) {
        // Create tab
...
//        scrollView.scrollTo(rb_px - scrollViewWidth / 2, 0);
    ...
    private void initDistance(int position) {
        switch (position) {
            case 0:
            ...
            case 2:
                ...
                break;
            case 3:
                scrollView.scrollTo(170 * 3 - 40, 0);
                break;
            case 4:
                scrollView.scrollTo(170 * 4 - 40, 0);
                break;
            case 5:
                scrollView.scrollTo(170 * 5 - 40, 0);
                break;
            case 6:
                scrollView.scrollTo(170 * 6 - 40, 0);
                break;
        }
    }
...
//        scrollView.scrollTo(rb_px - scrollViewWidth / 2, 0);
    ...
    public void setOnTabClickListener(MyEasyIndicator.onTabClickListener onTabClickListener) {
