 ...
 * 解决初始化选中指示器显示问题
 */
public class MyNewEasyIndicator extends LinearLayout implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    public MyNewEasyIndicator(Context context) {
        super(context);
    }

    public MyNewEasyIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        scrollView.scrollTo(rb_px - scrollViewWidth / 2, 0);
        ...
        if (indicator_isBottom_line) {
            ...
            tvs[position].post(new Runnable() {
                @Override
                public void run() {
                    Logger.wtf("宽度==" + tvs[position].getWidth());
    ...
    private void initDistance(int position) {
        switch (position) {
            ...
            case 2:
                ...
                break;
            case 3:
                scrollView.scrollTo(140 * 3 - 40, 0);
                break;
            case 4:
                scrollView.scrollTo(140 * 4 - 40, 0);
                break;
        }
    }
...
//        scrollView.scrollTo(rb_px - scrollViewWidth / 2, 0);
    ...
    public void setOnTabClickListener(MyNewEasyIndicator.onTabClickListener onTabClickListener) {
